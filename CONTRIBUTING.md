...
First off, thank you for considering contributing to heuristics. 
It's people like you that make heuristics great!
...
```bash
git clone https://github.com/cryptopatrick/heuristics.git
cd heuristics
```
...
To run heuristics, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/heuristics/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/heuristics/issues) to report any bugs or request new features.
...
Thank you for contributing to heuristics!
